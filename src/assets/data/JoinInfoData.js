...
본 이용약관은 “현대백화점 투홈”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반사항 규정을 목적으로 합니다.
...
① 회사는 일정 금액 또는 일정 비율을 할인받을 수 있는 쿠폰을 발급할 수 있으며, 쿠폰의 종류 및 내용과 발급 여부는 회사의 정책에 따라 운영 및 변경될 수 있습니다.
② 쿠폰은 사전에 명시된 유효기간 내에 사용될 수 있으며, 유효기간이 지나거나 회원 자격이 상실되면 소멸됩니다.
③ 회사는 회원이 사이트 내에서 상품을 구매하거나 상품 후기 작성 등의 활동을 하는 경우 정책에 따라 일정한 포인트를 지급할 수 있습니다. 다만, 상품 구매 후 취소 또는 반품하게 될 경우, 지급한 포인트가 회수됩니다.
④ 회사는 포인트 및 쿠폰 관련하여 다음의 사항을 SMS, 알림톡, 친구톡, 카카오 채널 메시지 등의 수단을 통해 회원에게 통지합니다.
1. 회원 가입 혜택의 부여
2. 등급별 지급되는 쿠폰 또는 포인트
3. 포인트 또는 쿠폰의 유효기간 안내, 유효기간 만료 및 소멸
4. 구매, 리뷰 작성 활동을 한 회원에게 감사 쿠폰 또는 포인트 부여
5. 그 외 기타 포인트 및 쿠폰의 부여, 사용, 만료, 소멸 등에 관한 사항
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
    ...
    {
        JoinInfoid: 3,
        name: '[선택] 마케팅 광고 활용을 위한 수집 및 이용 동의',
        info: `현대백화점 투홈은 개인정보 보호법 제22조 제4항과 제39조의 3에 따라 사용자의 광고성 정보 수신과 이에 따른 개인정보 처리에 대한 동의를 받고 있습니다.
약관에 동의하지 않으셔도 현대백화점 투홈의 모든 서비스를 이용하실 수 있습니다. 다만 이벤트, 혜택 등의 제한이 있을 수 있습니다.
- 개인정보 수집 항목
- 이름,휴대폰 번호, 이메일, 성별,생년월일- 혜택 정보,이벤트 정보,상품 정보,신규 서비스 안내 등의 광고성 정보 제공
- 개인정보 수집 이용 목적
- 이벤트 운영 및 광고성 정보 전송
- 서비스 관련 정보 전송
- 보유 및 이용 기간
